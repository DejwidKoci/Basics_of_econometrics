...
print("Wnioski: Dla zmiennych X1, X2, X3 współczynnik VIF jest mniejszy od 10. Zmienne te charakteryzują się brakiem współliniowości, a więc nie są ze sobą silnie skorelowane.")