...
#print(f"Model: {round(b1,2)}x + {round(b2,2)}")
print(f"Interpretacja parametru b1: Jeśli dochód wzrośnie o jednostkę to sporzycie mięsa wzrośnie średnio o {b1} kg na osobę")
print("R-value: ", r)
print("p-value: ", p)
print("Standard error of the parametr: ", std_error)
print(f"R-squared: {r_squared}, zatem {r_squared} całkowitej zmienności sporzycia mięsa (y) zostało wyjaśnione modelem. " )
